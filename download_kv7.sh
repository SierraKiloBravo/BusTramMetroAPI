...
wget -P kv78dl/KV7planning/ $(curl http://kv7.openov.nl/GOVI/KV7planning/ |   grep -io '<a class=\"link\" href=['"'"'"][^"'"'"']*['"'"'"]' |   sed -e 's/^<a class=\"link\" href=["'"'"']//i' -e 's/["'"'"']$//i' -e 's/^/http:\/\/kv7.openov.nl\/GOVI\/KV7planning\//' | tail -n1500)
